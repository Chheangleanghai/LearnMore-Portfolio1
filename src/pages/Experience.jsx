...
const experiences = [
  {
    ...
    link: "https://chheangleanghai.vercel.app/", // Add link here
  },
  {
    ...
    link: "https://key-nest-omega.vercel.app/", // This one
  },
  {
    ...
    period: "2025",
    description:
      "Full-stack app with ReactJS & Tailwind CSS frontend and Laravel backend. Features JWT authentication and RESTful API CRUD for managing products with a responsive, user-friendly interface.",
    technologies: [
      "ReactJS", "Tailwind CSS", "Laravel", "PostgreSQL", "RESTful API", "JWT", "CRUD", "Responsive Design"
    ],
    link: "https://your-product-app.vercel.app/", // Add link here
  },
];
  ...
  return (
    <section className="min-h-screen py-20 ">
      ...
      {experiences.map((exp, index) => (
          <div
            key={index}
            onClick={() => window.open(exp.link, "_blank")} // just this line
            className="cursor-pointer block mb-12 ml-6 relative group"
          >
